...
import { addReview } from "../actions/addReview.action";
import {
  COMMENT_MAX_LENGTH,
  SUCCESS_MESSAGE_DELETE_DELAY,
} from "../consts/details.consts";
...
import InterActiveRatingStars from "@/components/ui/InterActiveRatingStars";
import Button from "@/components/common/Button";
import MiniLoader from "@/components/common/MiniLoader";
import FormStateMessage from "@/components/common/FormStateMessage";
...
function AddReviewForm({ productId }: { productId: number }) {
  ...
  const onSubmit = async (data: CreateReviewInput) => {
    startTransition(async () => {
      const state = await addReview(data);
