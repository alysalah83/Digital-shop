...
import { ProductWithDiscount } from "../types/product.type";
import Button from "@/components/common/Button";

function ProductDiscountCard({ product }: { product: ProductWithDiscount }) {
  const { name, discountPercentage, image, description, id } = product;
  return (
...
export default memo(ProductDiscountCard);
