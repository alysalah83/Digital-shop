import HeroProductMainCard from "@/app/(landing)/_components/hero-section/HeroProductMainCard";
...
function HeroProductsSlider({ products }: { products: Product[] }) {
  return (
      ...
      <Slider count={products.length}>
        <SliderCards>
          {products.map((product) => (
            ...
            >
              <HeroProductMainCard product={product} />
            </div>
          ))}
        </SliderCards>
...
export default HeroProductsSlider;
